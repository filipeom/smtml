...
let keywords =
  ...
  Array.iter
    ...
    [| ("int" , INT_TYPE)
     ...
     (* ; ("real.neg", UNARY (Real Neg)) *)
     (* ; ("real.abs", UNARY (Real Abs)) *)
     (* ; ("real.sqrt", UNARY (Real Sqrt)) *)
     (* ; ("real.nearest", UNARY (Real Nearest)) *)
     (* ; ("real.is_nan", UNARY (Real IsNan)) *)
     (* ; ("real.add", BINARY (Real Add)) *)
     (* ; ("real.sub", BINARY (Real Sub)) *)
     (* ; ("real.div", BINARY (Real Div)) *)
     (* ; ("real.mul", BINARY (Real Mul)) *)
     (* ; ("real.rem", BINARY (Real Rem)) *)
     (* ; ("real.min", BINARY (Real Min)) *)
     (* ; ("real.max", BINARY (Real Max)) *)
     ; ("real.eq", REAL_EQ)
     ; ("real.ne", REAL_NE)
     (* ; ("real.lt", RELOP (Real Lt)) *)
     (* ; ("real.le", RELOP (Real Le)) *)
     (* ; ("real.gt", RELOP (Real Gt)) *)
     (* ; ("real.ge", RELOP (Real Ge)) *)
     ...
     ; ("bool.ne", BOOL_NE)
     ; ("bool.ite", BOOL_ITE)
     (* ; ("str.len", UNARY (Str Len)) *)
     (* ; ("str.nth", BINARY (Str Nth)) *)
     (* ; ("str.++", BINARY (Str Concat)) *)
     (* ; ("str.sub", TERNARY (Str SubStr)) *)
     ; ("str.eq", STR_EQ)
     ; ("str.ne", STR_NE)
