...
module Make () = struct
  ...
  let tty_of_etype (e : Ty.t) : DTerm.ty =
    ...
    | Ty_fp 32 -> float32_ty
    | Ty_fp 64 -> float64_ty
    | Ty_fp _ | Ty_bitv _ | Ty_list | Ty_app | Ty_unit | Ty_none -> assert false
  ...
  module I :
    ...
    let encode_unop op e =
      let op' =
        ...
        | Neg -> DTerm.Int.minus
        | _ ->
          Fmt.failwith {|Int: Unsupported Z3 unop operator "%a"|} Ty.pp_unop op
      in
      op' e
    ...
    let encode_triop op _ _ _ =
      Fmt.failwith {|Arith: Unsupported Z3 triop operator "%a"|} Ty.pp_triop op
  end
  ...
  module Real :
    ...
    let encode_cvtop op e =
      let op' =
        ...
        | _ ->
          Fmt.failwith {|Real: Unsupported Z3 cvtop operator "%a"|} Ty.pp_cvtop
            op
      in
      op' e
  ...
  let encode_unop = function
    ...
    | (Ty.Ty_list | Ty_app | Ty_unit | Ty_none) as op ->
      Fmt.failwith "Colibri2_mappings: Trying to code unsupported op of type %a"
        Ty.pp op
  ...
  *)
  ...
  module Optimizer = struct
    ...
    let get_statistics _ =
      Fmt.failwith "Colibri2_mappings: Optimizer.get_statistics not implemented"
  end
  ...
  let c2value_to_value (ty : Ty.t) (v : Colibri2_core.Value.t) =
    ...
    | Ty_str | Ty_list | Ty_app | Ty_unit | Ty_none ->
      Fmt.failwith "Colibri2_mappings2: Unsuppoted model generation of type %a"
        Ty.pp ty
